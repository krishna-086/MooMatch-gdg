...
import { collection, addDoc, deleteDoc, doc, serverTimestamp, getDocs } from "firebase/firestore";
...
const Marketplace = () => {
  ...
  const hardcodedProducts= [
    {
      id: 1,
      name: "Dry Fodder",
      description: "High-quality nutritious dry fodder for cattle",
      price: 150,
      inStock: true,
      category: "fodder",
      image: "/Fodder.png",
    ...
    },
    {
      id: 2,
      name: "Green Grass",
      description: "Fresh organic grass for optimal cow health",
      price: 80,
      inStock: true,
      category: "fodder",
      image: "/grass.png",
    ...
    },
    {
      id: 3,
      name: "Gir Cow",
      description: "Premium Indian Gir breed with high milk yield",
      price: 35000,
      inStock: true,
      category: "cow",
      image: "/gir1.png",
    ...
    },
    {
      id: 4,
      name: "Sahiwal Cow",
      description: "Pure Sahiwal breed known for milk quality",
      price: 40000,
      inStock: true,
      category: "cow",
      image: "/sahiwal1.png",
    ...
    const fetchProducts = async () => {
      try {
        ...
        const loadedProducts = querySnapshot.docs.map(doc => ({
          id: doc.id,
          ...doc.data(),
          isHardcoded: false // Flag for Firestore products
        }));
        setFirestoreProducts(loadedProducts);
        setProducts([...hardcodedProducts, ...loadedProducts]);
      } catch (err) {
  ...
  const handleAddProduct = async (e) => {
    ...
    try {
      const docRef = await addDoc(collection(db, "products"), {
        ...
        quantityUnit: newProduct.category === "cow" ? "count" : "kg",
      ...
      setProducts([...hardcodedProducts, ...firestoreProducts, {
        id: docRef.id,
        ...newProduct,
        price: Number(newProduct.price),
        quantity: Number(newProduct.quantity),
  ...
  const renderProductCard = (product) => (
    <motion.div
      key={product.id}
      whileHover={{ y: -5 }}
      className="bg-white rounded-lg shadow-lg overflow-hidden border border-gray-100 hover:shadow-xl transition-shadow relative"
    >
      {/* Delete button for Firestore products */}
      {!product.isHardcoded && (
        <button
          onClick={() => handleDeleteProduct(product.id)}
          className="absolute top-2 right-2 bg-red-500 text-white rounded-full p-2 z-10 hover:bg-red-600"
        >
          <FaTimes size={12} />
        </button>
      )}
      ...
      <div className="p-4">
        ...
        <p className="text-sm text-[#662929] mb-2">
          Available: {product.quantity} {product.quantityUnit}
        </p>
        <div className="flex justify-between items-center">
          <p className="text-xl font-bold text-[#662929]">
      ...
      <div className="mt-12 pb-12">
        ...
        <div className="bg-[#662929] text-white py-12 px-6 text-center">
          ...
          <p className="text-xl opacity-90">
            Premium cattle feed and livestock marketplace
          </p>
        </div>
              ...
              {showAddForm && (
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-sm font-medium text-[#662929] mb-1">
                        Product Name
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="flex items-center">
                      ...
                      />
                      <label className="ml-2 text-sm text-[#662929]">
                        In Stock
                      </label>
                    </div>
                  </div>
              ...
              {cart.length === 0 ? (
                ...
                <>
                    ...
                    {cart.map((item) => (
                      ...
                      >
                        <div className="flex-1">
                          <h3 className="font-semibold text-[#662929]">
                            {item.name}
                          </h3>
                  ...
                  <div className="mt-6 pt-4 border-t">
                    ...
                    <button className="w-full bg-[#662929] text-white py-3 rounded-lg font-medium hover:bg-[#662929] transition mt-6">
                      Proceed to Checkout
                    </button>
                  </div>
                </>
