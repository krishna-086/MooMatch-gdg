...
const EduContent = () => {
  ...
  const cowBreeds = [
    {
      name: "Holstein",
      image: "holstein.png",
      description: "Known for high milk production.",
    },
    {
      name: "Jersey",
      image: "cow.jpg",
      description: "Smaller cows with rich, creamy milk.",
    },
    {
      name: "Guernsey",
      image: "cow.jpg",
      description: "Produces golden-colored milk.",
    },
    {
      name: "Brown Swiss",
      image: "cow.jpg",
      description: "Strong and adaptable breed.",
    },
    {
      name: "Ayrshire",
      image: "cow.jpg",
      description: "Hardy and efficient milk producers.",
    },
    {
      name: "Shorthorn",
      image: "cow.jpg",
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col">
      ...
      >
        <h2 className="text-2xl md:text-3xl font-semibold text-[#662929] mb-4 md:mb-6">
          Manure as Organic Fertilizer
        </h2>
        <p className="text-gray-700 text-base md:text-lg mb-4 md:mb-6">
          Cow manure is an excellent organic fertilizer, improving soil health
          and crop yields. It enhances soil fertility by providing essential
          nutrients.
        </p>
